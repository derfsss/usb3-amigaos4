...
SEC_CODE enum VSTAT __Driver_Valid( struct USBBase *usbbase UNUSED, struct USB3_DriverNode *dn, STR file UNUSED )

#else

SEC_CODE enum VSTAT __Driver_Valid( struct USBBase *usbbase UNUSED, struct USB3_DriverNode *dn )
