...
SEC_CODE void __Config_Unlock( struct USBBase *usbbase, struct USB3_ConfigNode *cn, STR file UNUSED )

#else

SEC_CODE void __Config_Unlock( struct USBBase *usbbase, struct USB3_ConfigNode *cn )
