...
SEC_CODE enum LSTAT __Config_Lock( struct USBBase *usbbase, struct USB3_ConfigNode *cn, STR file UNUSED )

#else

SEC_CODE enum LSTAT __Config_Lock( struct USBBase *usbbase, struct USB3_ConfigNode *cn )
