...
SEC_CODE enum LSTAT __Interface_LockHeader( struct USBBase *usbbase, struct USB3_InterfaceHeader *ih, STR file UNUSED )

#else

SEC_CODE enum LSTAT __Interface_LockHeader( struct USBBase *usbbase, struct USB3_InterfaceHeader *ih )
