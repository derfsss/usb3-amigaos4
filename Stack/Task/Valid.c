...
SEC_CODE enum VSTAT __Task_Valid( struct USBBase *usbbase UNUSED, struct USB3_TaskNode *tn, STR file UNUSED )

#else

SEC_CODE enum VSTAT __Task_Valid( struct USBBase *usbbase UNUSED, struct USB3_TaskNode *tn )
