...
SEC_CODE void __Task_Unlock( struct USBBase *usbbase, struct USB3_TaskNode *tn, STR file UNUSED )

#else

SEC_CODE void __Task_Unlock( struct USBBase *usbbase, struct USB3_TaskNode *tn )
