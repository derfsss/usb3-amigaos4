...
SEC_CODE void	XHCI_Handler_HCD( struct USB3_HCDNode *hn, U32 mask );
...
SEC_CODE S32	XHCI_Port_Set_Power( struct USB3_HCDNode *hn, U32 port );
...
SEC_CODE void	XHCI_Control_Add( struct USB3_HCDNode *hn, struct RealRequest *ioreq );
SEC_CODE void	XHCI_Control_Remove( struct USB3_HCDNode *hn, struct RealRequest *ioreq );
SEC_CODE U32	XHCI_Control_Length( struct USB3_HCDNode *hn, struct RealRequest *ioreq );
...
SEC_CODE void	XHCI_Bulk_Remove( struct USB3_HCDNode *hn, struct RealRequest *ioreq );
...
SEC_CODE void	XHCI_Interrupt_Add( struct USB3_HCDNode *hn, struct RealRequest *ioreq );
SEC_CODE void	XHCI_Interrupt_Remove( struct USB3_HCDNode *hn, struct RealRequest *ioreq );
SEC_CODE U32	XHCI_Interrupt_Length( struct USB3_HCDNode *hn, struct RealRequest *ioreq );

// -- Transfer Ring helper

SEC_CODE U32	XHCI_Ring_Enqueue_TRB( struct USB3_HCDNode *hn, struct XHCI_Ring *ring, struct XHCI_TRB *trb );
